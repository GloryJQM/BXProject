...
typedef NS_ENUM(NSUInteger, NumberLabelStyle)
{
    NumberLabelStyleDefault,
    NumberLabelStyleValue1       // Only show last numberLabel
};
...
@property (nonatomic) BOOL showSeparatedLabel;
...
@property (nonatomic) CGFloat drawDataAnimateTime;
...
@property (nonatomic, assign) NumberLabelStyle numberLabelStyle;
