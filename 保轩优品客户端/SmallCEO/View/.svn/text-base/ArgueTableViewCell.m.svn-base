...
#import "ArgueTableViewCell.h"

@implementation ArgueTableViewCell
...
//        [middleView addSubview:_GoodTotalNum];
        ...
        _quxiaoButton.frame = CGRectMake(UI_SCREEN_WIDTH - 100, CGRectGetMaxY(self.moneyLabel.frame) + 5, 100, 30) ;
