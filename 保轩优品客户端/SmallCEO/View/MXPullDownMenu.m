...
- (MXPullDownMenu *)initWithTitleArray:(NSArray *)titleArray array:(NSArray *)array selectedColor:(UIColor *)color
{
    self = [super init];
    if (self) {
        ...
        for (int i = 0; i < _numOfMenu; i++) {
            ...
            CATextLayer *title = [self creatTextLayerWithNSString:titleArray[i] withColor:_menuColor andPosition:position];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.textLabel setTextColor:SUB_TITLE];
...
- (CGSize)calculateTitleSizeWithString:(NSString *)string
{
    ...
    CGSize size = [string boundingRectWithSize:CGSizeMake([[UIScreen mainScreen] bounds].size.width-40, 0) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:dic context:nil].size;
    return size;
}
